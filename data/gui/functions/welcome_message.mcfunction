...
tellraw @s {"text": "Click here to check the change log! (it might contain some new features! :O)","color": "red","clickEvent": {"action": "run_command","value": "/function gui:display_changelog"}}
function gui:tellraw_line