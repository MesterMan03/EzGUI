...
data modify storage gui:pages TempItem set from entity @e[tag=selectedgui,limit=1] Items[{Slot:15b}]
data modify storage gui:pages ActualItem set from entity @e[tag=itemcheck,limit=1] Items[{Slot:15b}]
