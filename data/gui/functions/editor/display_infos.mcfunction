...
tellraw @s {"text": "2. Hold the item in your hand, then type /trigger set rightclick/leftclick/shiftclick/returnclick/drop(stack)click set <command_id> to set the command id!","color": "gray"}
